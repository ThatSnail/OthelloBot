...
$pyjs.loaded_modules['game'] = function (__mod_name__) {
	...
	, 1, [null,null,['self']]);
		...
		$method = $pyjs__bind_method2('move', function(x, y, player, preserve_state) {
			if (this.__is_instance__ === true) {
				var self = this;
			} else {
				var self = arguments[0];
				...
				y = arguments[2];
				player = arguments[3];
				preserve_state = arguments[4];
			}
			if (typeof player == 'undefined') player=arguments.callee.__args__[5][1];
			if (typeof preserve_state == 'undefined') preserve_state=arguments.callee.__args__[6][1];
			var flipped_stone,$iter6_type,$iter3_type,$iter6_iter,$iter6_nextval,$iter3_idx,nx,ny,black,$iter3_iter,white,$or1,$iter6_idx,$or2,fx,fy,$and5,$and6,$iter6_array,$iter3_array,d,flip,$add2,$add3,$add1,$add4,$iter3_nextval;
	...
	return $collcomp3;}();
					...
					while ($p['bool'](true)) {
						...
						if ($p['bool'](($p['bool']($or1=!$p['bool']($m['Game']['is_tile'](nx, ny)))?$or1:$p['op_eq']($p['getattr'](self, 'state').__getitem__(nx).__getitem__(ny), $p['getattr']($m['Game'], 'NONE'))))) {
							...
							while (typeof($p['__wrapped_next']($iter6_nextval).$nextval) != 'undefined') {
								...
								fx = $tupleassign3[0];
								fy = $tupleassign3[1];
								if ($p['bool'](!$p['bool'](preserve_state))) {
				...
				if ($p['bool'](flipped_stone)) {
					if ($p['bool'](!$p['bool'](preserve_state))) {
						...
						if ($p['bool'](($p['bool']($and5=$p['op_eq'](self['liberties']($p['getattr']($m['Game'], 'BLACK')), 0))?$p['op_eq'](self['liberties']($p['getattr']($m['Game'], 'WHITE')), 0):$and5))) {
							var $tupleassign4 = $p['__ass_unpack']($p['tuple']([self['stones']($p['getattr']($m['Game'], 'BLACK')), self['stones']($p['getattr']($m['Game'], 'WHITE'))]), 2, null);
	...
	, 1, [null,null,['self'],['x'],['y'],['player', null],['preserve_state', false]]);
		...
		$method = $pyjs__bind_method2('is_valid_move', function(x, y, player) {
			...
			if (typeof player == 'undefined') player=arguments.callee.__args__[5][1];
			var $pyjs_try_err,valid;
			if ($p['bool']($p['op_eq'](player, null))) {
				player = $p['getattr'](self, 'current_player');
			}
			valid = true;
			try {
				$pyjs_kwargs_call(self, 'move', null, null, [{preserve_state:true}, x, y, player]);
			} catch($pyjs_try_err) {
	...
	, 1, [null,null,['self'],['x'],['y'],['player', null]]);
		...
		$method = $pyjs__bind_method2('liberties', function(player, state) {
			...
			var $iter7_nextval,$iter7_iter,$iter7_array,liberties,$iter7_idx,y,x,$iter7_type;
			if ($p['bool']($p['op_eq'](player, null))) {
				player = $p['getattr'](self, 'current_player');
			}
			...
			liberties = $p['list']([]);
			$iter7_iter = function(){
				var $iter8_idx,$iter9_iter,$iter9_nextval,$iter8_type,$collcomp4,$iter8_array,$iter9_idx,$iter9_array,$iter8_iter,$iter8_nextval,y,x,$iter9_type;
	$collcomp4 = $p['list']();
	...
	, 1, [null,null,['self'],['player', null],['state', null]]);
		...
		$method = $pyjs__bind_method2('stones', function(player, state) {
			if (this.__is_instance__ === true) {
				var self = this;
			} else {
				var self = arguments[0];
			...
			if (typeof state == 'undefined') state=arguments.callee.__args__[4][1];
			var stones,$iter10_nextval,y,$iter10_array,$add6,$add5,$iter10_type,x,$iter10_iter,$iter10_idx;
			if ($p['bool']($p['op_eq'](state, null))) {
				state = $p['getattr'](self, 'state');
			}
			stones = 0;
			$iter10_iter = function(){
				var $iter12_type,$iter11_iter,$collcomp5,$iter11_type,$iter12_array,$iter12_iter,$iter11_array,y,x,$iter11_nextval,$iter11_idx,$iter12_idx,$iter12_nextval;
	$collcomp5 = $p['list']();
	...
	return $collcomp5;}();
			...
			while (typeof($p['__wrapped_next']($iter10_nextval).$nextval) != 'undefined') {
				...
				if ($p['bool']($p['op_eq'](state.__getitem__(x).__getitem__(y), player))) {
					stones = $p['__op_add']($add5=stones,$add6=1);
				}
			}
			return stones;
		}
	, 1, [null,null,['self'],['player'],['state', null]]);
