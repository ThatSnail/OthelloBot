...
$pyjs.loaded_modules['main'] = function (__mod_name__) {
	...
	$m['event'] = function() {
		...
		while (typeof($p['__wrapped_next']($iter2_nextval).$nextval) != 'undefined') {
			...
			if ($p['bool']($p['op_eq']($p['getattr'](event, 'type'), $p['getattr']($m['pygame'], 'MOUSEBUTTONUP')))) {
...
/*
PYJS_DEPS: ['sys', 'time', 'pygame', 'game.Game', 'game', 'math.floor', 'math', 'human_player.HumanPlayer', 'human_player', 'computer_player.ComputerPlayer', 'computer_player']
*/
