...
$pyjs.loaded_modules['computer_player'] = function (__mod_name__) {
	...
	$m['sleep'] = $p['___import___']('time.sleep', null, null, false);
...
/*
PYJS_DEPS: ['time.sleep', 'time', 'player.Player', 'player', 'game.Game', 'game', 'strategy.Strategy', 'strategy', 'strategy_random.RandomStrategy', 'strategy_random', 'strategy_corner.CornerStrategy', 'strategy_corner']
*/
